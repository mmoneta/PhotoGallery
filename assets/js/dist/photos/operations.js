    ...
    photoItems.forEach(function (photoItem) {
      if (photoItem.getElementsByClassName("delete-button").length > 0) {
        ...
        deleteButton.onclick = function (event) {
          return deleteClickHandler(event, photoItem);
        };
      }
      ...
      if (photoItem.getElementsByClassName("edit-button").length > 0) {
        ...
        editButton.onclick = function (event) {
          return editClickHandler(event, photoItem);
        };
      }
      ...
      if (photoItem.getElementsByClassName("left-rotate-button").length > 0) {
        ...
        leftRotateButton.onclick = function (event) {
          return rotateClickHandler(event, photoItem, 'left');
        };
      }
      ...
      if (photoItem.getElementsByClassName("right-rotate-button").length > 0) {
        ...
        rightRotateButton.onclick = function (event) {
          return rotateClickHandler(event, photoItem, 'right');
        };
      }
      ...
      if (photoItem.getElementsByClassName("save-button").length > 0) {
        ...
        saveButton.onclick = function (event) {
          return saveClickHandler(event, photoItem);
        };
      }
    });
  }
