      ...
      switch (action) {
        case 'login':
          if (response)
            ...
            window.location.href = `//${window.location.hostname}/PhotoGallery/dashboard`;
          break;
        case 'register':
          if (response)
            alert(response);
          else {
            Array.from(document.querySelectorAll ("#register-form input")).forEach(element => element.value = null);
        ...
        case 'change_password':
          if (response)
            ...
            Array.from(document.querySelectorAll("#modalChangePasswordForm input")).forEach(element => element.value = null);
            $(() => $('#modalChangePasswordForm').modal('toggle'));
          }
          break;
        case 'create_category':
          if (response) {
